...
class TestJoints(ConverterTestCase):
    ...
    def test_hinge_joints(self):
        ...
        self.assert_rotation_almost_equal(joint.GetLocalRot0Attr().Get(), Gf.Quatf(1, Gf.Vec3f(0, 0, 0)), self.tolerance)
        self.assert_rotation_almost_equal(joint.GetLocalRot1Attr().Get(), Gf.Quatf(1, Gf.Vec3f(0, 0, 0)), self.tolerance)
        ...
        self.assertEqual(joint.GetLocalPos1Attr().Get(), Gf.Vec3f(0, 0.1, 0))
        self.assert_rotation_almost_equal(joint.GetLocalRot0Attr().Get(), Gf.Quatf(0.0, Gf.Vec3f(-1.0, 0.0, 0.0)), self.tolerance)
        self.assert_rotation_almost_equal(joint.GetLocalRot1Attr().Get(), Gf.Quatf(0.0, Gf.Vec3f(-1.0, 0.0, 0.0)), self.tolerance)
    ...
    def test_slide_joints(self):
        ...
        self.assertTrue(Gf.IsClose(joint.GetLocalPos0Attr().Get(), Gf.Vec3f(0, 0.6, 0), self.tolerance))
        self.assertEqual(joint.GetLocalPos1Attr().Get(), Gf.Vec3f(0, 0.1, 0))
        self.assert_rotation_almost_equal(joint.GetLocalRot0Attr().Get(), Gf.Quatf(1, Gf.Vec3f(0.0, 0.0, 0)), self.tolerance)
        self.assert_rotation_almost_equal(joint.GetLocalRot1Attr().Get(), Gf.Quatf(1, Gf.Vec3f(0.0, 0.0, 0)), self.tolerance)
        self.assertAlmostEqual(joint.GetLowerLimitAttr().Get(), 0)
        ...
        self.assert_rotation_almost_equal(joint2.GetLocalRot0Attr().Get(), Gf.Quatf(1, Gf.Vec3f(0.0, 0.0, 0)), self.tolerance)
        self.assert_rotation_almost_equal(joint2.GetLocalRot1Attr().Get(), Gf.Quatf(1, Gf.Vec3f(0.0, 0.0, 0)), self.tolerance)
        ...
        self.assert_rotation_almost_equal(joint3.GetLocalRot1Attr().Get(), Gf.Quatf(1, Gf.Vec3f(0, 0, 0)), self.tolerance)
    ...
    def test_ball_joints(self):
        ...
        self.assertTrue(Gf.IsClose(joint2.GetLocalPos0Attr().Get(), Gf.Vec3f(0, 0.6, 0), self.tolerance))
        self.assertEqual(joint2.GetLocalPos1Attr().Get(), Gf.Vec3f(0, 0.1, 0))
        self.assert_rotation_almost_equal(joint2.GetLocalRot0Attr().Get(), Gf.Quatf(1, Gf.Vec3f(0, 0, 0)), self.tolerance)
        self.assert_rotation_almost_equal(joint2.GetLocalRot1Attr().Get(), Gf.Quatf(1, Gf.Vec3f(0, 0, 0)), self.tolerance)
    ...
    def test_fixed_and_free_joints(self):
        ...
        self.assert_rotation_almost_equal(fixed_joint.GetLocalRot1Attr().Get(), Gf.Quatf(1, Gf.Vec3f(0, 0, 0)), self.tolerance)
    ...
    def test_joint_to_worldbody(self):
        ...
        self.assert_rotation_almost_equal(joint_prim.GetLocalRot0Attr().Get(), Gf.Quatf(1, Gf.Vec3f(0, 0, 0)), self.tolerance)
        self.assert_rotation_almost_equal(joint_prim.GetLocalRot1Attr().Get(), Gf.Quatf(1, Gf.Vec3f(0, 0, 0)), self.tolerance)
